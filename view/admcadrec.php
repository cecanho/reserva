...
<div class="w3-center">
    ...
    <form method="post" action="cadrec.php">
        <div><label>Nome:</label></div>
        <div><input type="text" name="nome" id="nome"></div><br>
        <div><label>Descrição:</label></div>
        <div><textarea name="descricao" id="descricao" rows="5" cols="30" maxlength="150">Coloque aqui a descrição até 150 letras.</textarea></div><br>
